...
class Customizer_Repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( file_exists( THEMEROOT . '/inc/admin/customizer-repeater/inc/icons.php' ) ) {
	...
	public function enqueue() {
		wp_enqueue_style( 'font-awesome', THEMEROOT.'/inc/admin/customizer-repeater/css/font-awesome.min.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'customizer-repeater-admin-stylesheet', THEMEROOT.'/inc/admin/customizer-repeater/css/admin-style.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'wp-color-picker' );
		wp_enqueue_script( 'customizer-repeater-script', THEMEROOT.'/inc/admin/customizer-repeater/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), CUSTOMIZER_REPEATER_VERSION, true  );
		wp_enqueue_script( 'customizer-repeater-fontawesome-iconpicker', THEMEROOT.'/inc/admin/customizer-repeater/js/fontawesome-iconpicker.min.js', array( 'jquery' ), CUSTOMIZER_REPEATER_VERSION, true );
		wp_enqueue_style( 'customizer-repeater-fontawesome-iconpicker-script', THEMEROOT.'/inc/admin/customizer-repeater/css/fontawesome-iconpicker.min.css', array(), CUSTOMIZER_REPEATER_VERSION );
	}
